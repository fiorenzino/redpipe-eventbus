...
//   }
   ...
   private static Object valueOf(Class<?> aClass, String fieldValue)
   {
      ...
      if (aClass.equals(Date.class))
      {
         try
         {
            return new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss").parse(fieldValue);
         }
         catch (Exception e)
         {
         }
      ...
      if (aClass.equals(Instant.class))
      {
         ...
         try
         {
            return new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss").parse(fieldValue).toInstant();
         }
         catch (Exception e)
         {
         }
         try
         {
            return new SimpleDateFormat("yyyy-MM-dd").parse(fieldValue).toInstant();
         }
         catch (Exception e)
         {
         }
         try
         {
            return new SimpleDateFormat("dd/MM/yyyy").parse(fieldValue).toInstant();
         }
         catch (Exception e)
         {
         }
         try
         {
            return new SimpleDateFormat("yyyy-MM-dd HH:mm").parse(fieldValue).toInstant();
         }
         catch (Exception e)
         {
         }
         try
         {
            return new SimpleDateFormat("dd/MM/yyyy HH:mm").parse(fieldValue).toInstant();
         }
         catch (Exception e)
         {
         }
         try
         {
            return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(fieldValue).toInstant();
         }
         catch (Exception e)
         {
         }
         try
         {
            return new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").parse(fieldValue).toInstant();
         }
         catch (Exception e)
         {
         }
         try
         {
            return new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").parse(fieldValue).toInstant();
         }
         catch (Exception e)
         {
         }
